...
public class FirstApiClient {
    ...
    private func microValidate(callback: @escaping ([String: Any]?, NSError?)->Void){
        callInputAlert(callback: {(inputAlert, authAnswer) -> Void in
    ...
    //enroll with PWMB
    public func performEnrollmentWithPWMB(onSuccess: @escaping (String?, NSError?) -> Void){
    ...
    private func validate(validateRequest: NSDictionary, callback: @escaping (String?, NSError?) -> Void){
        ...
        post(path_url: route, body: validateRequest as! [String : AnyObject], onCompletion: {(json: [String: Any], error: NSError?) in
            ...
            if error != nil {
                ...
                self.enrollPWMB(enrollmentRequest: enrollmentRequest, callback: callback)
            }
        })
    }
    //api call to enroll with PWMB
    private func enrollPWMB(enrollmentRequest: NSDictionary, callback: @escaping (String?, NSError?) -> Void){
    ...
    private func callInputAlert(callback: @escaping (UIAlertController, String) -> Void){
